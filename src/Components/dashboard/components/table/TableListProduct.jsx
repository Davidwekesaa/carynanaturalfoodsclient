...
const TableListProduct = ({ rows }) => {
  ...
  const orderSuccess = () => toast.success("Product Deleted Successfuly");
  ...
  return (
    <div className="dash-table-data">
        ...
        >
          <TableHead className="dash-tableHead">
            <TableRow>
              ...
              <TableCell className="dash-tableCell">Price</TableCell>
              <TableCell className="dash-tableCell">Quantity</TableCell>
              <TableCell className="dash-tableCell">no. Items</TableCell>
              {user.userRights !== 1 ? (
          ...
          <TableBody>
            {rows.map((row) => (
              ...
              >
                ...
                <TableCell className="dash-tableCell">{row.price}</TableCell>
      ...
      >
        ...
        <DialogContent>
          <NewUserProductEdit id={updateId} />
        </DialogContent>
        <DialogActions className="dailog-dash-status"></DialogActions>
      </Dialog>
