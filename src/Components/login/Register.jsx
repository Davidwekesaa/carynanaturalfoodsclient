    ...
    <div className="login">
      <div className="l-image">
        <div className="imgBox logo-image">
          <img src={imgUpload== null? notImge : imgUpload} alt="profile" className="profilePic" />
        </div>
        <AddAPhotoIcon
